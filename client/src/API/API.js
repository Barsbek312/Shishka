...
export const authAPI = {
    ...
    async registerUser(userData) {
        let res = await instance.post(`%5Eauth/users/`, userData);
        return res;
    },

    async login(userData) {
        console.log(userData);
        let res = await instance.post(`%5Eauth/users/login/`, userData);
        return res;
    },

    async logout() {
        let res = await instance.get(`%5Eauth/users/logout/`);
        return res;
    },
    async me() {
        let res = await instance.get(`%5Eauth/users/me/`);
        return res;
    },
    ...
    async verify(data) {
        let res = await instance.post("%5Eauth/users/activation/", data);
        console.log(res);
        return res;
    }
